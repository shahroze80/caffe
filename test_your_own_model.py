...
# free parameters
TEST_DB_PATH = '../input/validation_lmdb'
ITERATIONS_START=5000
ITERATIONS_END=10000
SNAPSHOT=1000   # constant
SNAPSHOT_PREFIX='bvlc_googlenet'
DEPLOT_FILE = '../caffe_models/bvlc_googlenet/deploy.prototxt'
PRETRAINED_MODEL_LOCATION = '../caffe_models/bvlc_googlenet/iterations_full/'
